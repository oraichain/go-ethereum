...
export interface ExampleStatelessSum3Interface extends Interface {
...
export interface ExampleStatelessSum3 extends BaseContract {
  connect(runner?: ContractRunner | null): ExampleStatelessSum3;
  waitForDeployment(): Promise<this>;

  interface: ExampleStatelessSum3Interface;
